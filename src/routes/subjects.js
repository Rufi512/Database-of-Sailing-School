...
router.put('/section/update/:id',[authJwt.verifyToken,authJwt.checkPassword,authJwt.isModerator],subjectsCtrl.updateSubjectsBySection) // Assign for section added previous
//PUT
